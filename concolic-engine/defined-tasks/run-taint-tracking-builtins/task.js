...
(async function Browser() {
  ...
  let max_url_num = configs.navigator.MAX_URL;
  ...
  let visitor = await new Visitor(configs, url, domain, basedir, max_url_num, userCallbacks.before, userCallbacks.action, userCallbacks.after, userCallbacks.post);
